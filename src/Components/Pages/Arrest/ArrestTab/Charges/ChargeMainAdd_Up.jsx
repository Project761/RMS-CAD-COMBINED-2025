                        ...
                        <div className="col-12 incident-tab">
                            <ul className='nav nav-tabs'>
                                <Link
                                    to={
                                        MstPage ?
                                            `/Arrest-Home?IncId=${IncID}&IncNo=${IncNo}&IncSta=${IncSta}&Name=${Name}&ArrestId=${ArrestId}&ArrestSta=${ArrestSta}&ChargeId=${ChargeId}&ArrNo=${ArrNo}&ChargeSta=${ChargeSta}`
...
export default ChargeMainAdd_Up