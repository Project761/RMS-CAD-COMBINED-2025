...
const DocumentAccess = ({ DecdocumentID, isCad = false, isViewEventDetails = false, isCADSearch = false }) => {
    ...
    const [value, setValue] = useState({
        AgencyID: '', DocumentID: '', GroupName: '', DocumentAccessID: '', DocumentAccess: '', DocumentName: '', DocumentTypeID: '', DocumentNotes: ''
    });
    ...
    const Agencychange = (multiSelected) => {
        ...
        setValue((prev) => ({
            ...prev,
            DocumentAccessID: id.toString(), DocumentAccess_Name: name.toString()
        }));
    };
                    ...
                    <>
                        <div className='row'>
                            <div className="col-2 col-md-2 col-lg-2 mt-3 pt-1">
                                <span htmlFor="" className='label-name '>User Name</span>
                            </div>
                            <div className="col-4 col-md-12 col-lg-4 dropdown__box">
                                <SelectBox
                                    options={agencyOfficerDrpData.filter(item => item.value !== loginPinID)}
                                    isMulti
