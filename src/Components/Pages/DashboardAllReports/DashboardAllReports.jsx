...
function DashboardAllReports({ isPreview }) {
                    ...
                    {row.ReportTypeJson === "Use Of Force" ? (
                        row?.ArrestID ? (
                            effectiveScreenPermission ?
                                effectiveScreenPermission[0]?.Changeok ? (
                                    <Link
                                        to={`/Arrest-Home?IncId=${stringToBase64(row?.IncidentID)}&IncNo=${(row?.IncidentNumber)}&IncSta=${true}&ArrestId=${stringToBase64(row?.ArrestID)}&ArrNo=${stringToBase64(row?.ArrestNumber)}&isFromDashboard=true`}
                                        onClick={() => set_IncidentId(row)}
                                        className="btn btn-sm bg-green text-white px-1 py-0 mr-1"
                                        style={{
                                            lineHeight: '1', minWidth: '22px', height: '22px', display: 'flex',
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <span className="mr-2 ">
                                    <svg width="32" height="32" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="128" height="128" rx="100" fill="#D6ECFF" />  {/* 👈 reduced from 24 to 8 */}
                                ...
                                <span className="fw-bold mb-0 " style={{ fontSize: '15px', fontWeight: '700', color: '#334c65' }}>My Reports</span>
                            </div>
...
const QueueReportsModal = (props) => {
    ...
    const Add_Type_Comments = () => {
        const { IsApprove, IsReject, ApprovalComments, ApprovingSupervisorID, IsApprovedForward } = value
                                ...
                                <>
                                    ...
                                    <div className="row g-3 ">
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <textarea
                                                className="form-control"
                                                style={{ minHeight: '50px', background: '#fff3cd' }}
