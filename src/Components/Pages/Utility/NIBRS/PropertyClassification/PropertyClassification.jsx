...
const PropertyClassification = (props) => {
    ...
    useEffect(() => {
        if (localStoreData) {
            ...
            get_data(localStoreData?.AgencyID, localStoreData?.PINID, localStoreData?.IsSuperadmin); setFilterTypeIdOption('Contains'); setFilterTypeDescOption('Contains');
        }
...
export default memo(PropertyClassification)
