...
const CaseManagementPerformanceRankingReport = () => {
                    ...
                    <div className="col-12 col-sm-12">
                        <div className="card Agency">
                            <div className="card-body">
                                <fieldset>
                                    <legend>Case Management Performance Ranking Report</legend>
...
export default CaseManagementPerformanceRankingReport