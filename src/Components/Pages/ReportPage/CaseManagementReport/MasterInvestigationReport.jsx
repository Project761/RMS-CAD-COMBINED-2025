...
import { get_AgencyOfficer_Data, get_Incident_Drp_Data, get_NIBRS_Drp_Data } from '../../../../redux/actions/DropDownsData';
import Loader from '../../../Common/Loader';
import ReportAddress from '../../ReportAddress/ReportAddress';
import { get_ScreenPermissions_Data } from '../../../../redux/actions/IncidentAction';

const MasterInvestigationReport = () => {
                    ...
                    <div className="col-12 col-sm-12">
                        <div className="card Agency">
                            <div className="card-body">
                                <fieldset>
                                    <legend>Master Investigation Report</legend>
                                    ...
                                    <div className="row mt-2">
                                        ...
                                        <div className="col-3 col-md-3 col-lg-2 mt-2 ">
                                            <label htmlFor="" className='new-label'>Primary Investigator</label>
                                        </div>
                                        <div className="col-3 col-md-3 col-lg-2 mt-1 ">
                                            <Select
                                                name='InvestigatorID'
                                        ...
                                        <div className="col-3 col-md-3 col-lg-2 text-right mt-2">
                                            <label htmlFor="" className='new-label'>CAD Disposition</label>
                                        </div>
                                        <div className="col-3 col-md-3 col-lg-2 mt-1">
                                            <Select
                                        ...
                                        <div className="col-3 col-md-3 col-lg-6 mt-1 text-field">
                                            <input type="text" name='VehicleNumber' id='VehicleNumber' style={{ textTransform: "uppercase" }} maxLength={12} value={value?.VehicleNumber} onChange={handlChange} className='' />
                                        </div>
...
export default MasterInvestigationReport