...
const FamilyViolenceReport = (props) => {
    ...
    const { masterReportData, showFields, searchValue, multiImage, rmsCfsID, GetFamilyReportData, showWatermark, setShowWatermark, } = props
    ...
    const handlePrintClick = () => {
        setShowFooter(true);
        setTimeout(() => {
            printForm(); GetFamilyReportData(true); setShowFooter(false);
        }, 100);
    };
    ...
    return (
        <>
            ...
            {
                masterReportData?.Relationship?.length > 0 ?
                    <>
                        <div className="col-12 col-md-12 col-lg-12  px-2" >
                            <div className="bg-line  py-1 px-2 mt-1 d-flex justify-content-between align-items-center">
                                <p className="p-0 m-0 d-flex align-items-center">Family Violence Summary Report</p>
                        ...
                        <div className="container mt-1" ref={componentRef} style={{ border: '1px solid #80808085', pageBreakAfter: 'always' }}>
                            ...
                            </div>
                            {
                                masterReportData?.Relationship?.length > 0 ?
                                    <>
                                        {
                                            masterReportData?.Relationship?.map((obj) => (
                                                <>
