...
const TreeModal = (props) => {
    ...
    const { proRoom, locationStatus, setLocationStatus, locationPath, setLocationPath, setSearchStoragePath, setValue, searchStoStatus, setSearchStoStatus, setPropertyNumber } = props
    ...
    const handleSelectSearch = (selectBranch) => {
        ...
        fetchPostData("PropertyStorageLocation/GetPathData_PropertyStorageLocation", val).then((data) => {
            if (data) {
                ...
                setSearchStoragePath(data[0].NodePath);
    ...
    return (
        TreeData &&
        <div className="modal fade" style={{ background: "rgba(0,0,0, 0.5)" }} id="MasterTreeModal" tabIndex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="false">
            <div className="modal-dialog modal-lg modal-dialog-centered rounded modal-dialog-scrollable">
                <div className="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title model-color">Master Report Storage Location</h5>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-md btn-success" data-toggle="modal" data-target="#MasterTreeModal" onClick={() => {
                            if (locationStatus) {
                        ...
                        <button type="button" class="btn btn-md btn-primary" aria-label="Close" data-dismiss="modal">Cancel</button>
                    </div>
                </div>
            </div>
        </div>
