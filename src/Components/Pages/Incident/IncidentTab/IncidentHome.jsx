    ...
    <>
      <div className="col-12 overflow-y-hidden">
        <div className="row bb">
          <div className="col-6">
            <div className="row mb-1">
              ...
              <div className="col-7 pl-1 col-md-7 col-lg-6  mt-1 requiredColor_input_mask ">
                {showAutoGenerated ? (
                  <input type="text" name="IncidentNumber" id="IncidentNumber" value="Auto Generated" readOnly disabled autoComplete="off" inputMode="none" maxLength={12} placeholder={Counter_Format} className="form-control py-1 new-input readonly" />
                ) : isSystemGenratedStatus ? (
                  <input type="text" name="IncidentNumber" id="IncidentNumber" value={value.IncidentNumber} readOnly disabled autoComplete="off" inputMode="none" maxLength={12} placeholder={Counter_Format} className="form-control py-1 new-input readonly" />
                ) : (
                  <InputMask
                    mask={inputMask}
                    maskChar="_"
          ...
          <div className="col-6">
            <div className="row mb-1">
              <div className="col-3 col-md-3 col-lg-6 mt-2 text-right">
                <span
                  data-toggle="modal"
              ...
              <div className="col-9 col-md-9 col-lg-6 mt-1">
                <Select
                  name="CaseStatusID"
          ...
          <div className="col-6">
            <div className="row">
              <div className="col-3 col-md-3 col-lg-6 mt-2">
                <label htmlFor="" className="new-label">
                  CAD Event #
                </label>
              </div>
        ...
        <div className="row bb">
          ...
          <div className="col-3 col-md-3 col-lg-2 mt-3">
            <label htmlFor="" className="new-label px-0">
          ...
          <div className="col-2 col-md-2 col-lg-2 mt-2 mb-2 d-flex">
            ...
            {!value?.IsVerify && addVerifySingleData.length > 0 ? (
              <i className="fa fa-edit pl-3 mt-1 pt-1 " data-toggle="modal" data-target="#VerifyModal" style={{ cursor: "pointer", backgroundColor: "" }}
                onClick={() => {
      ...
      <div className="col-12 mt-1 ">
        <div className="row">
          ...
          <div className="col-9  col-md-9 col-lg-3 mt- ">
            <Select
          ...
          <div className="col-3 col-md-3 col-lg-2 mt-2 ">
            <span className="new-label">CAD CFS Code</span>
          </div>
          <div className="col-9 col-md-9 col-lg-3  mt-1">
            <Select
              name="CADCFSCodeID"
          ...
          {/* <div className="col-3 col-md-3 col-lg-4 mt-2 pt-1"></div>
          <div className="col-9  col-md-9 col-lg-3 "></div> */}
          <div className="col-3 col-md-3 col-lg-4 mt-2 pt-1">
          ...
          <div className="col-5 col-md-5 col-lg-4 mt-2 pt-1">
            <label htmlFor="" className="new-label ">
      ...
      <div className="row mt-2 align-items-center">
        <div className="col-3 col-md-3 col-lg-2 mt-1">
          <label className="new-label">Print Format</label>
        </div>
