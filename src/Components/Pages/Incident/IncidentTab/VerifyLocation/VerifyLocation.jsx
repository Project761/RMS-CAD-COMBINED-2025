...
const VerifyLocation = (props) => {
    ...
    const { loginAgencyID, modalStatus, setModalStatus, value, setValue, addVerifySingleData, get_Add_Single_Data, setOnSelectLocation, setStatesChangeStatus } = props
    ...
    const [locationVal, setLocationVal] = useState({
        ...
        'AgencyName': '', 'LocationID': '', 'PremiseNo': '', 'PremiseNo_Parse': '', 'Street': '', 'Street_Parse': '', 'CommonPlace': '',
        'ApartmentNo': '', 'ApartmentType': '', 'CountryID': '', 'Country': '', 'State': '', 'CityID': '', 'City': '', 'ZipCodeID': '',
        'Statefullname': '', 'ZipCode': '', 'DirectionPrefix': '', 'DirectionSufix': '', 'DirectionPrefix_Parse': '', 'DirectionSuffix_Parse': '',
        'TypeSufix': '', 'TypeSuffix_Parse': '', 'Address': '', 'IsUsLocation': 'Y', 'IsActive': '1',
    });
    ...
    const check_Validation_Error = (e) => {
        if (locationVal?.IsUsLocation === 'Y') {
            ...
            const ApartmentTypeErr = locationVal.ApartmentNo?.trim() ? RequiredFieldIncident(locationVal?.ApartmentType) : 'true';
    ...
    const selectHandleChange = (e, name, nameCode) => {
        ...
        if (e) {
            if (name === 'State') {
                getCity(e.value)
                setLocationVal({ ...locationVal, [name]: e.value, ['StateFullName']: e.label, ['CityID']: '', ['City']: null, ['ZipCodeID']: '', ['ZipCode']: null, });
            } else if (name === 'CityID') {
            ...
            if (name === 'CityID') {
                ...
                setLocationVal({
                    ...locationVal, [name]: '', ['Country']: '', ['State']: '', ['StateFullName']: '', ['CityID']: '', ['City']: '', ['ZipCodeID']: '', ['ZipCode']: '',
                });
    ...
    const ResetOnChange = () => {
        if (addVerifySingleData[0]?.IsUsLocation === 'Y' && locationVal?.IsUsLocation === 'Y' && addVerifySingleData.length > 0) {
            ...
            setLocationVal({
                ...locationVal,
                'PremiseNo': '', 'PremiseNo_Parse': '', 'I_PremiseNo_Parse': '', 'Street': '', 'Street_Parse': '', 'I_Street_Parse': '', 'CommonPlace': '',
                'Commonplace_Parse': '', 'ApartmentNo': '', 'ApartmentNo_Parse': '', 'ApartmentType': '', 'ApartmentType_Parse': '', 'CountryID': '',
                'Country': '', 'State': '', 'StatefullName': '', 'StateFullname': '', 'City': '', 'CityID': '', 'ZipCodeID': '', 'ZipCode': '',
                'Area': '', 'DirectionPrefix': '', 'DirectionSufix': '', 'TypeSufix': '', 'Latitude': '', 'Longitude': '', 'LocationAlias': '',
                'GeoCords': '', 'ORINumber': '', 'LocationType': '', 'RecommandedAddress': '', 'MunicipalityCode': '', 'JurisCode': '', 'ind_col': '',
                'PatrolArea': '', 'ZoneCode': '', 'ZoneDesc': '', 'MainX': '', 'MainY': '', 'MainZ': '', 'AlternateX': '', 'AlternateY': '',
                'AlternateZ': '', 'DirectionPrefix_Parse': '', 'TypeSuffix_Parse': '', 'DirectionSuffix_Parse': '', 'I_DirectionPrefix_Parse': '',
                'I_TypeSuffix_Parse': '', 'I_DirectionSuffix_Parse': '', 'MuniCode_Parse': '', 'JurisCode_Parse': '', 'GAPID': '', 'DISTRICT': '',
                'GRID': '', 'IsAddressFROMNonUS': '', 'LOCUniqID': '', 'TypePrefix': '', 'Division': '', 'Field_office': '', 'Direction': '',
                'GCModifier': '', 'Location_ID': '', 'KeyMAP': '', 'MP_Prefix': '', 'Milepost': '', 'MP_Suffix': '', 'NSPDType': '', 'NSPDUniqueID': '',
                'SegmentRange': '', 'CrossingsDOTNum': '', 'CrossingsFullName': '', 'NSPDName': '', 'XRMSDisplayText': '', 'Address': '',
                'MP_Number': null,
            });
        }
        if (addVerifySingleData[0]?.IsUsLocation === 'N' && locationVal?.IsUsLocation === 'N' && addVerifySingleData.length > 0) {
            ...
            setLocationVal({
                ...locationVal,
                'PremiseNo': '', 'PremiseNo_Parse': '', 'I_PremiseNo_Parse': '', 'Street': '', 'Street_Parse': '', 'I_Street_Parse': '', 'CommonPlace': '',
                'Commonplace_Parse': '', 'ApartmentNo': '', 'ApartmentNo_Parse': '', 'ApartmentType': '', 'ApartmentType_Parse': '', 'CountryID': '', 'Country': '',
                'State': '', 'Statefullname': '', 'StatefullName': '', 'City': '', 'CityID': '', 'ZipCodeID': '', 'ZipCode': '', 'Area': '', 'DirectionPrefix': '',
                'DirectionSufix': '', 'TypeSufix': '', 'Latitude': '', 'Longitude': '', 'LocationAlias': '', 'GeoCords': '', 'ORINumber': '', 'LocationType': '',
                'RecommandedAddress': '', 'MunicipalityCode': '', 'JurisCode': '', 'ind_col': '', 'PatrolArea': '', 'ZoneCode': '', 'ZoneDesc': '', 'MainX': '',
                'MainY': '', 'MainZ': '', 'AlternateX': '', 'AlternateY': '', 'AlternateZ': '', 'DirectionPrefix_Parse': '', 'TypeSuffix_Parse': '', 'DirectionSuffix_Parse': '',
                'I_DirectionPrefix_Parse': '', 'I_TypeSuffix_Parse': '', 'I_DirectionSuffix_Parse': '', 'MuniCode_Parse': '', 'JurisCode_Parse': '', 'GAPID': '',
                'DISTRICT': '', 'GRID': '', 'IsAddressFROMNonUS': '', 'LOCUniqID': '', 'TypePrefix': '', 'Division': '', 'Field_office': '', 'Direction': '',
                'GCModifier': '', 'Location_ID': '', 'KeyMAP': '', 'MP_Prefix': '', 'Milepost': '', 'MP_Suffix': '', 'NSPDType': '', 'NSPDUniqueID': '', 'SegmentRange': '',
                'CrossingsDOTNum': '', 'CrossingsFullName': '', 'NSPDName': '', 'XRMSDisplayText': '', 'Address': '',
                'MP_Number': null,
            });
        }
    ...
    const Reset = () => {
        setLocationVal({
            ...locationVal,
            'IsUsLocation': 'Y', 'PremiseNo': '', 'PremiseNo_Parse': '', 'I_PremiseNo_Parse': '', 'Street': '', 'Street_Parse': '', 'I_Street_Parse': '', 'CommonPlace': '',
            'Commonplace_Parse': '', 'ApartmentNo': '', 'ApartmentNo_Parse': '', 'ApartmentType': '', 'ApartmentType_Parse': '', 'CountryID': '', 'Country': '', 'State': '',
            'Statefullname': '', 'StateFullName': '', 'City': '', 'CityID': '', 'ZipCodeID': '', 'ZipCode': '', 'Area': '', 'DirectionPrefix': '', 'DirectionSufix': '',
            'TypeSufix': '', 'Latitude': '', 'Longitude': '', 'LocationAlias': '', 'GeoCords': '', 'ORINumber': '', 'LocationType': '', 'RecommandedAddress': '',
            'MunicipalityCode': '', 'JurisCode': '', 'ind_col': '', 'PatrolArea': '', 'ZoneCode': '', 'ZoneDesc': '', 'MainX': '', 'MainY': '', 'MainZ': '', 'AlternateX': '',
            'AlternateY': '', 'AlternateZ': '', 'DirectionPrefix_Parse': '', 'TypeSuffix_Parse': '', 'DirectionSuffix_Parse': '', 'I_DirectionPrefix_Parse': '',
            'I_TypeSuffix_Parse': '', 'I_DirectionSuffix_Parse': '', 'MuniCode_Parse': '', 'JurisCode_Parse': '', 'GAPID': '', 'DISTRICT': '', 'GRID': '',
            'IsAddressFROMNonUS': '', 'LOCUniqID': '', 'TypePrefix': '', 'Division': '', 'Field_office': '', 'Direction': '', 'GCModifier': '', 'Location_ID': '', 'KeyMAP': '',
            'MP_Number': null, 'MP_Prefix': '', 'Milepost': '', 'MP_Suffix': '', 'NSPDType': '', 'NSPDUniqueID': '', 'SegmentRange': '', 'CrossingsDOTNum': '',
            'CrossingsFullName': '', 'NSPDName': '', 'XRMSDisplayText': '', 'Address': '',
        });
        setErrors({
            ...errors,
                                                            ...
                                                            <div className="row">
                                                                <div className="col-12  col-md-12 col-lg-12 mt-1 ">
                                                                    <div className=" text-field ">
                                                                        <textarea name='Street' id="Street" onChange={HandleChange} value={locationVal?.Street} cols="30" rows='2'
                                                                            className="form-control pt-2 pb-2 requiredColor" style={{ resize: 'none' }}></textarea>
                                                                ...
                                                                <div className="col-6 col-md-6  col-lg-3 dropdown__box">
                                                                    <Select
                                                                        ...
                                                                        onChange={(e) => {
                                                                            selectHandleChange(e, 'CountryID', 'Country')
                                                                            if (!e) { setLocationVal(prev => ({ ...prev, Statefullname: '' })); }
                                                                        }
                                                                        }
                                                                        placeholder="Select..."
                                                                    />
                                                                ...
                                                                <div className="col-6 col-md-6  col-lg-3  " style={{ marginTop: '2px' }}>
                                                                    <div className="text-field  ">
                                                                        <input type="text" name='ZipCode' id='ZipCode' value={locationVal?.ZipCode} onChange={HandleChange} required autoComplete='off' maxLength={5} />
