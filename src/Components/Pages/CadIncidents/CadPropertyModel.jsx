...
const CadPropertyModel = (props) => {
  ...
  const { modelActivityStatus, DecPropID, DecMPropID, rowData, setDataSaved, SelectedCategory, CallStatus, ProType, ProNumber, ProTransfer, CheckboxStatus, ProCategory, taskListID, modalOpenStatus, setModalOpenStatus } = props
  ...
  return (
    ...
    <>
      ...
      <div class="modal fade" style={{ background: "rgba(0,0,0, 0.5)" }} id="MasterModalProperty" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false">
