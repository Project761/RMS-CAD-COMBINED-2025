...
const SearchModel = (props) => {
    const { whiteboardSearchModal, setOpenWhiteboardSearchModal, whiteboardSearchData, setWhiteboardSearchData, setIsSearch } = props;
                ...
                {whiteboardSearchModal ? (
                    ...
                    >
                        <div className="modal-dialog modal-dialog-centered modal-xl1">
                            <div className="modal-content modal-content-cad_search">
                                <div className="modal-body">
                                    ...
                                    <div className="m-1">
                                        <fieldset style={{ border: "1px solid gray" }}>
                                            <div className="tab-form-container_Search">
                                                <div className="row align-items-center " style={{ rowGap: "0.5rem" }}>
                                                    ...
                                                    <div className="col-2 text-right ">
                                                        <label className="tab-form-label_Search  text-nowrap ">Category</label>
                                                    </div>
                                                    <div className="col-4">
                                                        <Select
                                                            name="category"
                                                    ...
                                                    <div className="col-2 text-right">
                                                        <label className="tab-form-label_Search text-nowrap ">Date From</label>
                                                    </div>
                                                    ...
                                                    <div className="col-2 text-right">
                                                        <label className="tab-form-label_Search text-nowrap ">Date To</label>
                                                    </div>
                                                    <div className="col-4 w-100 cad-DatePicker">
                                                        <DatePicker
                                                            className="mt-0"
                                                    ...
                                                    <div className="col-2 text-right">
                                                        <label className="tab-form-label_Search d-flex justify-content-end mr-1 text-nowrap">Title</label>
                                                    </div>
                                                    ...
                                                    <div className="col-2 text-right">
                                                        <label className="tab-form-label_Search d-flex justify-content-end mr-1 text-nowrap">Message</label>
                                                    </div>
                                                    <div className="col-10">
                                                    ...
                                                    <div className="col-12 p-0">
                                                        <div className="py-0 px-2 d-flex justify-content-end align-items-center">
                                                            <div className="d-flex justify-content-end  mt-1">
                                                                ...
                                                                <button type="button" data-dismiss="modal" className="btn btn-sm btn-success mr-1 common-button" onClick={() => handleSearch()} disabled={isSearchStateEmpty(whiteboardSearchState)}>
                                                                    Search
                                                                </button>

                                                                <button type="button" data-dismiss="modal" className="btn btn-sm btn-success common-button_close mr-1" onClick={() => { setOpenWhiteboardSearchModal(false); clearWhiteboardSearchState(); }}>
                                                                    Close
                                                                </button>
                                                            </div>
                                                        </div>
