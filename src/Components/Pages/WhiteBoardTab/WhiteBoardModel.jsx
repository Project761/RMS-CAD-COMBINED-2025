...
import { AddDelete_Img } from "../../hooks/Api";
...
import { customStylesWithFixedHeight, requiredFieldColourStyles } from "../../../CADComponents/Utility/CustomStylesForReact";
import whiteboard from "../../../CADServices/APIs/whiteboard";
...
const WhiteBoardModal = (props) => {
    ...
    const getImages = async (ID) => {
        if (ID) {
            ...
            const response = await whiteboard.getWhiteboardDoc(payload);
    ...
    const removeImage = async (index, image) => {
        ...
        if (image?.DocumentID) {
            ...
            await whiteboard.deleteWhiteboardDoc(payload);
        }
    };
    ...
    async function handleSave() {
        ...
        let response = []
        if (isUpdate) {
            response = await whiteboard.updateWhiteboard(data);
        } else {
            response = await whiteboard.insertWhiteboard(data);
        }
                                    ...
                                    <>
                                        <div className="m-1">
                                            <fieldset style={{ border: "1px solid gray" }}>
                                                <div className="row align-items-center mt-2 " style={{ rowGap: "0.5rem" }}>

                                                    <div className="col-2 text-right">
                                                        <label className="tab-form-label_Search ">Category{errorWhiteboardState.category && isEmpty(whiteboardState?.category) && (
                                                    ...
                                                    <div className="d-flex col-10">
                                                        ...
                                                        />
                                                        <div className="col-2 text-right">
                                                            <label className="tab-form-label_Search text-nowrap">Priority</label>
                                                        </div>
                                                        <Select
                                                            isClearable
                                                    ...
                                                    <div className="col-2 text-right ">
                                                        <label for="" className="tab-form-label_Search">Title {errorWhiteboardState.title && isEmpty(whiteboardState?.title) && (
                                                    ...
                                                    <div className="col-2 text-right ">
                                                        <label for="" className="tab-form-label_Search">Message  {errorWhiteboardState.message && isEmpty(whiteboardState?.message) && (
                                                    ...
                                                    <div className="col-2 text-right">
                                                        <label className="tab-form-label_Search  text-nowrap">Upload File</label>
                                                    </div>
                                                    ...
                                                    <div className="tab-form-row col-10 offset-2">
                                                        <div
                                                            className="cad-images image-preview cursor pointer"
                                                            style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: '10px' }}
                                                        >
                                                            {selectedImages.map((image, index) => (
                                                                <div
                                                                    key={index}
                                                                    className="imagesWhiteB image-containerWhiteB"
                                                                    data-toggle="modal"
                                                                    ...
                                                                    style={{
                                                                        ...
                                                                        alignItems: 'center',
                                                                        width: '120px',  // adjust width to accommodate text & button nicely
                                                                    }}
                                                                >
                                                                    {image.whiteBoardID ? (
                                                                    ...
                                                                    <button
                                                                        className="delete-buttonWhiteBoard"
                                                                        onClick={(e) => {
                                                    ...
                                                    <div className="col-12 p-0 d-flex justify-content-end align-items-center">
                                                        <div className="py-0 px-2 d-flex justify-content-end align-items-center">
                                                            ...
                                                            <div className="d-flex justify-content-end tab-form-row-gap mt-1">
                                                                ...
                                                                <button type="button" data-dismiss="modal" className="btn btn-sm btn-success mr-1 whiteboard-button" disabled={isLoading || (!!whiteboardState?.whiteBoardID && !isDataUpdated)} onClick={() => handleSave()}>
                                                                    {WhiteboardID ? "Update" : "Save"}
                                                                </button>
                                                                ...
                                                                <button type="button" data-dismiss="modal" className="btn btn-sm btn-success mr-1 whiteboard-button" onClick={() => handelClear()}>
                                                                    Clear
                                                                </button>
                                                                {/* <button
                                                                    type="button"
                                                                    data-dismiss="modal"
                                                                    className="whiteboard-button_close"
                                                                    onClick={() => handleCancel()}
                                                                >
                                                                    Close
                                                                </button> */}

                                                                <button type="button" data-dismiss="modal" className="btn btn-sm btn-success whiteboard-button_close mr-1" onClick={() => handleCancel()}>
                                                                    Close
                                                                </button>
                                                            </div>
