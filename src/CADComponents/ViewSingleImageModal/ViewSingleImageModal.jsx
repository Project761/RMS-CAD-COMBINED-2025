...
const ViewSingleImageModal = (props) => {
    const { isOpenViewSingleImageModal, setIsOpenViewSingleImageModal, viewSingleImage, id } = props;
    return (
        <>
                                    ...
                                    <div className="imagemodalcontainer" style={{ overflow: 'hidden', width: '620px' }}>
                                        <div style={{ display: 'flex', transition: 'transform 0.3s ease' }}>
                                            <div className="img-box" style={{ flex: '0 0 auto', margin: '0 0px' }}>
                                                <img
                                                    src={id ? viewSingleImage.FileAttachment : URL.createObjectURL(viewSingleImage)}
                                                    style={{
                                                        height: '500px',
                                                        width: '620px',
                                                        maxHeight: '500px',
